// -----------------------------------------------------------------------------
//  meshsorter_core.hpp: the MeshSorter model and the replication design.
//
//  This header holds everything that is shared between the command-line
//  simulator (meshsorter.cpp) and the buffer-allocation certification program
//  (certify_rep.cpp): the geometry, the transfer rule, one replication, and the
//  Student t quantile used to form intervals.  The documentation of the model
//  and of the geometry is in the block comment below and in README.md.
// -----------------------------------------------------------------------------
#ifndef MESHSORTER_CORE_HPP
#define MESHSORTER_CORE_HPP
...
[[maybe_unused]] static double tquantile975(int df) {
